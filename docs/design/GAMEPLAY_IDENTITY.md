...
- Starting deck uses `QuickStep` and `ClaymoreArc` as the two non-basic common cards so a new run can build Chivalry and immediately see a Destruction spend pattern.
